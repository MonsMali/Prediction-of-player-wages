...
from data_cleaning_3 import scaler, pca
from data_cleaning_3 import to_snake_case
from joblib import load

# Load training model
mlr_model = load("C:/Users/Administrator/OneDrive/Ambiente de Trabalho/Master Classes/2nd Semester/Data Science project/Football project/Football-top-5-leagues-player-wage-prediction/ml_model.pkl")

# Load new data
df_new = pd.read_csv("C:/Users/Administrator/OneDrive/Ambiente de Trabalho/Master Classes/2nd Semester/Data Science project/Football project/Football-top-5-leagues-player-wage-prediction/scraped_data_for_ML_test.csv", encoding='latin-1')  
