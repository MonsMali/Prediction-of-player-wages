...
# Load training model
mlr_model = load("C:/Users/Administrator/OneDrive/Ambiente de Trabalho/Master Classes/2nd Semester/Data Science project/Football project/top5 eur leagues DSP/pca_model.pkl")
